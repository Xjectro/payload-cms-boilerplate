...
import type { Props as MediaProps } from '@/components/payload/fields/media/types';
...
function ImageMedia({
  ...
  if (!src && resource && typeof resource === 'object') {
    ...
    src = `${process.env.NEXT_PUBLIC_SITE_URL}${url}?${cacheTag}`;
  }
...
export { ImageMedia };
export type { Props as ImageMediaProps };
