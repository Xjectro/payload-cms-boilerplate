...
export const Nav = ({ children, className, id, style, containerClassName }: DSProps) => (
  <nav className={cn(className)} id={id} style={style}>
    <div id="nav-container" className={cn('container py-3', containerClassName)}>
      {children}
    </div>
  </nav>
);
  ...
  return (
    <Component
      className={cn(
        ...
        // Block elements
        '[&_blockquote]:border-border [&_blockquote]:bg-muted/30 [&_blockquote]:text-muted-foreground [&_blockquote]:my-4 [&_blockquote]:border-l-4 [&_blockquote]:py-2 [&_blockquote]:pl-4!',
